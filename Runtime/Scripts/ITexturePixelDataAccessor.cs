...
/// </summary>
public interface ITexturePixelDataAccessor
{
    /// <summary>
...
/// </summary>
public class DirectX11TexturePixelDataAccessor : ITexturePixelDataAccessor
{
    /// <summary>
    /// GetPixelDataFromTexture retrieves pixel data from a Unity texture and returns a pointer to it.
    /// </summary>
...
/// </summary>
public class DirectX12TexturePixelDataAccessor : ITexturePixelDataAccessor
{
    /// <summary>
    /// GetPixelDataFromTexture retrieves pixel data from a Unity texture and returns a pointer to it.
    /// </summary>
